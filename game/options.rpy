...
define config.name = _("Macross Positive: Wings of Freedom")
...
define config.version = "ALFA ver."


## Texto situado en la pantalla 'Acerca de' del juego. Sitúa el texto entre
## comillas triples y deja una línea en blanco entre párrafos.

define gui.about = _p("""Disclaimer:

    Conocido como "ProjectMP". Gran parte de fondos, musica e imagenes tienen licencia perteneciente a Age. Otra gran parte pertenecen a Kadokawa. Otras son de libre uso. Esta obra no esta pensada para ser distribuida publicamente o ser monetizada.

Sinopsis:
    Han pasado cuatro años desde la Operación Babylon. Eres conocido como el ranger, un misterioso personaje, superviviente al Gran Cataclismo y el último Ranger en la Tierra. Tendrás que readaptarte en lo que queda del país que una vez serviste, y lidiar con el estado actual de la Tierra. En el viaje conocerás o recordarás a varias personas, y te verás envuelto en una trama politica, militar, y filosofica, pero tambien de amor. Es tu viaje por recuperar algo que olvidaste, y por avanzar.

Autor:
    Iker de Silesia "Skull".
""")
...
define config.main_menu_music = "INSANITY.mp3"
...
define config.save_directory = "ProjectMP-1695205832"
